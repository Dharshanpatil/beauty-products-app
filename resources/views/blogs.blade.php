...
@section('content')
    <div class="main-content">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="data-table-top d-flex flex-wrap gap-10 justify-content-between">
                                        ...
                                        <a href="{{route('admin.add-blogs')}}" class="btn btn--primary">
                                                                                  Add new
     ...
     <img class="avatar avatar-lg mr-3 avatar--3-1 rounded-full" src="/storage/app/public/blogs/{{$category['thumbnail']}}">
     </div>
     </td>
                                            ...
                                            <!--</button>-->
                                                            ...
                                                            <form action="{{route('admin.blogs-destroy',$category['id'])}}"
